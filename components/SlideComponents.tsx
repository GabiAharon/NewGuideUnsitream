...
const aboutSections = [
    ...
    { 
        ...
        content: `<ul class="list-none p-0">
                      <li class="mb-3">• <span class="text-pink-400 font-semibold">22 מרכזי יזמות</span> בפריסה ארצית.</li>
...
// 11. FAQ Slide (was 12)
const faqs = [
    { q: 'מתי אני פונה לליאור?', a: 'פנייה לליאור בנושאים הבאים: תקלות במבנה שלא נפתרו מול הרשות, אישור ספקים חדשים, תקציב שוטף ותקציב שופרסל, בעיות עם ציוד משרדי ודיו למדפסת.', contact: [{type: 'email', value: 'operation@unistream.co.il'}, {type: 'phone', value: '054-3546108'}]},
